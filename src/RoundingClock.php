    ...
    public function now(): DateTimeImmutable
    {
        ...
        if ($this->rounding <= self::ROUND_HOURS) {
            ...
            if (PHP_VERSION_ID < 70100) {
                ...
                // coverage is generated by PHP 8.2 where these hacks are not needed
        ...
        if (PHP_VERSION_ID < 70100) {
            ...
            $now = DateTimeImmutable::createFromFormat('U', $now->format('U'))
                ->setTimezone($now->getTimezone()); // round microseconds
